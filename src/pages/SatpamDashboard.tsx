  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="container mx-auto p-4">
        <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100">Satpam Dashboard</h1>
        <p className="text-gray-700 dark:text-gray-300">Selamat datang, {user.first_name} {user.last_name}!</p>
        <div className="mt-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Fitur Satpam akan datang di sini...</h2>
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Ini adalah placeholder untuk timeline harian dan form pengecekan APAR.
          </p>
        </div>
      </div>
    </div>
